...
WAIT_QUEUE_CLIENT_TIMEOUT_SECONDS = 60
...
BUFFER_RECONCILE_DEBOUNCE_SECONDS = 0.2
BUFFER_RECONCILE_RESYNC_SECONDS = 60
BUFFER_POLICY_READY_TTL_SECONDS = 15
BUFFER_POLICY_READY_RENEW_SECONDS = 5
BUFFER_SCALE_DOWN_GATE_TTL_SECONDS = 15
BUFFER_SCALE_DOWN_GATE_RENEW_SECONDS = 5
BUFFER_SCALE_DOWN_WAIT_TIMEOUT_SECONDS = 10
...
COMPUTE_AGENT_IDLE_RELEASE_SECONDS = 60
